...
`
const codeString1 = `import Stack from '@mui/material/Stack';
import LinearProgress from '@mui/material/LinearProgress';`

const codeString2 = `<Stack sx={{ width: '100%', color: 'grey.500' }} spacing={2}>
<LinearProgress color="secondary" />
<LinearProgress color="success" />
<LinearProgress color="inherit" />
</Stack>`
...
const  Progress  = () => {
  ...
  return (
    ...
    <b><h1 style={{fontSize:'2rem'}}>Progress</h1></b>
    
    <p style={{color:"#99999F"}}>Displays an indicator showing the completion progress <br /> of a task, typically displayed as a progress bar.</p>
