...
const Combobox = () => {
  ...
  <b><h1 style={{fontSize:'2rem'}}>Combobox</h1></b>
  ...
  <p>The Combobox is built using a composition of the Popover  and the Command <br />  components.</p>
<br />
  

  <p>See installation instructions for the Popover and the Command components.</p>
