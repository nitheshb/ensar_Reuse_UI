...
const codeString2 = `<Box sx={{ display: 'flex' }}>
<Button variant="outlined" color="neutral" onClick={toggleDrawer(true)}>
  Open drawer
</Button>
<Drawer open={open} onClose={toggleDrawer(false)}>
...
const  Sheet  = () => {
  ...
  return (
    ...
    <b><h1 style={{fontSize:'2rem'}}>Sheet</h1></b>
    
    <p style={{color:"#99999F"}}>Extends the Dialog component to display content <br /> that complements the main content of the screen.</p>
